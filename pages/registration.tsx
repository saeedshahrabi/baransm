...
import styles from "./../src/assets/styles/registration.module.scss";
...
const Registration: React.FunctionComponent<IProps> = () => {
            ...
            <div className={`${styles.registerationWrapper}  d-flex`}>
              <div className={`${styles.formRegisteration}`}>
                ...
                <div className="text-center">
                  <button onClick={() => setPageMode(Pagemode.signUp)}>ثبت نام در سایت</button>
                </div>
              </div>
              <div className={styles.desceriptionRegisteration}>
                ...
                <div>
                  <span>
                    <em className="fa fa-facebook-f"></em>
                  </span>
                  <span>
                ...
                <Formik initialValues={initialValueForSignin} onSubmit={(v) => submitFormSignIn(v)}>
                  {({ handleSubmit }) => (
                    <>
                      <div className="row justify-content-center">
                        <div className="col-md-7">
                          <FormControl control={APP_FORM_CONTROL.INPUT} name={"email"} placeholder={"ایمیل"} />
                        </div>
                      </div>
                      <div className="row justify-content-center">
                        <div className="col-md-7">
                          <FormControl control={APP_FORM_CONTROL.INPUT} name={"password"} placeholder="رمز عبور" />
                        </div>
                      </div>
          ...
          <div className="container position-relative" style={{ zIndex: 222 }}>
            <div className={`${styles.registerationWrapper}  d-flex`}>
              <div className={styles.desceriptionRegisteration}>
                ...
                <Formik initialValues={initialValueForSignup} onSubmit={(v) => submitFormSignUp(v)} validationSchema={validationSignUp}>
                  {({ handleSubmit, dirty, isValid, handleReset }) => (
                    <>
                      <div className="row justify-content-center">
                        <div className="col-md-7">
                          <FormControl control={APP_FORM_CONTROL.INPUT} name={"first_name"} placeholder={"نام"} label={"نام"} required />
                        </div>
                      </div>
                      <div className="row justify-content-center">
                        <div className="col-md-7">
                      ...
                      <div className="row justify-content-center">
                        <div className="col-md-7">
                          <FormControl control={APP_FORM_CONTROL.INPUT} name={"email"} placeholder={"ایمیل"} label={"ایمیل"} required />
                        </div>
                      </div>
                      <div className="row justify-content-center">
                        <div className="col-md-7">
                          <FormControl control={APP_FORM_CONTROL.INPUT} name={"password"} placeholder="رمز عبور" label="رمز عبور" required />
                        </div>
                      </div>
                      <div className={`${styles.btnSignUP} text-center`}>
              ...
              <div className={styles.formRegisteration}>
                ...
                <div className="text-center">
                  <button onClick={() => setPageMode(Pagemode.signIn)}>صفحه ورود</button>
                </div>
              </div>
            </div>
          </div>
  ...
  return <Layout>{PageMode === Pagemode.signIn ? signIn() : signUp()}</Layout>;
};
